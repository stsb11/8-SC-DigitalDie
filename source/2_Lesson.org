...
- Luckily there is a solution. Place a 100kΩ resistor between the pin and the ground rail, as shown below.
...
- Let's see if the 100kΩ resistor helps us on our real circuit.
